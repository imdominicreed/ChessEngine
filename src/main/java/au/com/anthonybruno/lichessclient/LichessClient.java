...
public class LichessClient implements AutoCloseable {
    ...
    public final JsonClient httpClient;
    ...
    public ObjectNode challengeAI() {
        return (ObjectNode) get(URLS.API + "/challenge/ai");
    }
    ...
    public void streamGameState(String gameId, GameEventHandler handler) {
        System.out.println(URLS.BOT + "/game/stream/" + gameId);
        httpClient.exit = false;
